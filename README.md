...
Let's stop talking theory and start talking about how we'd take some of the automation we've written so far and embed it within a very basic test framework. Alright, I'm in my code editor, and I'm going to start with one of the Appium scripts we wrote earlier. It's called [<code>elements_ios.py</code>](https://github.com/lana-20/appium-test-runners-frameworks/blob/main/elements_ios.py), and it's in the <code>mobile</code> directory in our project. 
